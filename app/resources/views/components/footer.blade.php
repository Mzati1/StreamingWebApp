<footer
    class="footer footer-center p-10 bg-inherit text-primary-content dark:bg-primary-content-dark dark:text-primary-dark">
    <aside class="flex items-center">
        <svg width="50" height="50" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd"
            clip-rule="evenodd" class="inline-block fill-current mr-2">
            <path
        ...
        <div>
            <p class="font-bold text-lg mb-2">Mzati Ltd.</p>
            <p class="mb-2">Providing reliable tech since 2006</p>
                     ...
                     1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797
                      6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108
                       1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415
                        3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444
                       3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768
        ...
        <a href="{{ config('socials.youtube') }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                ...
                <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356
                     2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245
                     11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615
